...
```
If the message `Successfully register or update data object which doId is 47d2b67c-ef80-45fc-814d-effd23baf788.` is printed, it means the data resource has been published successfully.
