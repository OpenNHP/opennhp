...
## [1.1.0](https://github.com/OpenNHP/opennhp/compare/v1.0.2...v1.1.0) (2026-09-17)
...
* **demoapp:** add account deregistration (local delete + server TTL) ([a364539](https://github.com/OpenNHP/opennhp/commit/a3645392c2431563ca4d4366d9b887b5b02e9464))
* **demoapp:** add GitHub OAuth login flow ([6cdae66](https://github.com/OpenNHP/opennhp/commit/6cdae66155f58d8df2629cbc54371976f7614116))
* **demoapp:** add integrated NHP demo app + relay/server registration fixes ([76a60f2](https://github.com/OpenNHP/opennhp/commit/76a60f2852bcd4cfbc1961ed77f87d0e5938ce8c))
* **demoapp:** add Simplified Chinese (i18n) + green source button ([ce2a1fa](https://github.com/OpenNHP/opennhp/commit/ce2a1faa74e3ea58b91788d8c4f7e2180afeee41))
* **demoapp:** deploy integrated demo app to demo.opennhp.org ([181b2db](https://github.com/OpenNHP/opennhp/commit/181b2dbc541cead536912c663e38d45628425033))
* **demoapp:** deploy integrated demo app to demo.opennhp.org ([622a1f9](https://github.com/OpenNHP/opennhp/commit/622a1f9ed2bc24f13d5ea8cd28baef4189940037))
* **demoapp:** match agent.opennhp.org language-switcher dropdown ([86ec671](https://github.com/OpenNHP/opennhp/commit/86ec6716cff35a0325c92cdf506931efbb46dbb4))
* **demoapp:** move language switcher inside the centered container ([1ff4da3](https://github.com/OpenNHP/opennhp/commit/1ff4da31ddf664af058796fdb2744e806b4e42e3))
* **demoapp:** multi-server + per-scheme registration ([8726d1b](https://github.com/OpenNHP/opennhp/commit/8726d1b8249ff6b730c766308bdba11baa936d61))
* **demoapp:** NHP binding chooser + login architecture diagram ([e8c4cbc](https://github.com/OpenNHP/opennhp/commit/e8c4cbc790d2c47188993a5bea500405817e9a3e))
* **demoapp:** open protected resource in a new tab on knock ([6d8e9aa](https://github.com/OpenNHP/opennhp/commit/6d8e9aa91f69147037ea48edd5d6987aa57a72d5))
* **demoapp:** restructure login layout, add footer + source link ([ac141d9](https://github.com/OpenNHP/opennhp/commit/ac141d948d07f20fdf08cf4699e3c91647245707))
* **demoapp:** restructure login layout, add footer + source link ([9970bf1](https://github.com/OpenNHP/opennhp/commit/9970bf114bb49758d75ef82e469c9bb16269ea4b))
* **demoapp:** retitle to "OpenNHP Login Integration Demo App" ([4ba2e2d](https://github.com/OpenNHP/opennhp/commit/4ba2e2d5124893b0fc73efce7bf024894959dbbb))
* **demoapp:** retitle, add Simplified Chinese (i18n) + language switcher ([819e1b3](https://github.com/OpenNHP/opennhp/commit/819e1b31e8ad0f028fe1de41789d8bd6c5f1cd6d))
* **demoapp:** show cipher scheme + auth provider after login ([9c045b1](https://github.com/OpenNHP/opennhp/commit/9c045b12c6ddf240eabc4be76e7fd9fdd52775d2))
...
* **ci:** add release-please manifest anchored at 1.0.0 ([b60abff](https://github.com/OpenNHP/opennhp/commit/b60abff19d22ba1738147d70be5c93dc0d5c2c39))
* **ci:** add release-please manifest anchored at 1.0.0 ([2f43208](https://github.com/OpenNHP/opennhp/commit/2f43208c5955ed2df8fb120a8a61f75e4b1aea3d))
...
* **ci:** mask demoapp master keys at source; drop key summary prefix echo ([d849645](https://github.com/OpenNHP/opennhp/commit/d8496455b5bca07792f7ddbf5bd65a810c8b3cfc))
...
* **ci:** serialize deploy-demoapp after deploy-jsagent to avoid certbot lock race ([16072f6](https://github.com/OpenNHP/opennhp/commit/16072f60c8535a76a0b6866dcd46f4d663ac92ef))
* **ci:** stop demoapp before binary scp to avoid ETXTBSY on redeploy ([a4b3172](https://github.com/OpenNHP/opennhp/commit/a4b317275e29f58532fa593eb26c111969d1c5ca))
...
* **core:** isolate asynchronous packet ownership ([c27ac84](https://github.com/OpenNHP/opennhp/commit/c27ac842a3477c80d108c5bd148c70dc987b675c))
* **core:** isolate asynchronous packet ownership ([cda5f54](https://github.com/OpenNHP/opennhp/commit/cda5f54fff1d5c97002cbb154318a6401e63116b))
...
* **demoapp:** adopt relay scheme when configured public key is still a placeholder ([22aad4b](https://github.com/OpenNHP/opennhp/commit/22aad4b0451ac3454011243eef7fecaed40a5853))
* **demoapp:** allow IdP sign-in when email is held by a password squat ([4c9c18a](https://github.com/OpenNHP/opennhp/commit/4c9c18ad9d76ce53cbc42c8a621091c4585c1653))
* **demoapp:** block pre-hijack email merge, enforce OIDC email_verified, reject unknown server, add CI/tests + .dockerignore ([f8e85f7](https://github.com/OpenNHP/opennhp/commit/f8e85f7990282a8a2fb751a42cb7abfd5b7911fb))
* **demoapp:** bound rate-limiter map; O(1) per request ([1cc7e81](https://github.com/OpenNHP/opennhp/commit/1cc7e81501e30b9128389b8804092b2bf1d60365))
* **demoapp:** create external-IdP users pending so they complete NHP_REG ([ed6fe45](https://github.com/OpenNHP/opennhp/commit/ed6fe450a58c99aa93fda0fe5caa5d248294ab46))
* **demoapp:** detect legacy email UNIQUE via pragmas + cascade-safe rebuild ([0786c93](https://github.com/OpenNHP/opennhp/commit/0786c93d4c06da70e178acf63ad18c0d6901e14c))
* **demoapp:** drop unused cleartext session-key writes ([ae25912](https://github.com/OpenNHP/opennhp/commit/ae259122b7224725fb368ad0992cb5bdc9ca7751))
* **demoapp:** explicit columns for users SELECT/INSERT ([32cc7bf](https://github.com/OpenNHP/opennhp/commit/32cc7bf00cff0943c4cadcf93ad329f5147fdd90))
* **demoapp:** harden public endpoint layer (SPA MIME + /register/confirm limiter) ([b75c698](https://github.com/OpenNHP/opennhp/commit/b75c6980ed3d8e20d3e6c6fa1df915353a4e253b))
* **demoapp:** keep OAuth secret out of artifact, honor deploy_binaries, Makefile decoupling, subject namespacing, rate limiting ([e9968e8](https://github.com/OpenNHP/opennhp/commit/e9968e85bbfbeaede17a16851b512678c8285070))
* **demoapp:** make X-Real-IP trust explicit via TrustProxyHeaders ([7fd365a](https://github.com/OpenNHP/opennhp/commit/7fd365ad01a7b535a46c55ca6f8bf63bba9ba1eb))
* **demoapp:** persist autogen sidecar before validation errors ([06feb90](https://github.com/OpenNHP/opennhp/commit/06feb906aecd9a4617649621f35b2f92867d8da5))
* **demoapp:** pin pragma + tx to one *sql.Conn in dropEmailUnique ([558ccdf](https://github.com/OpenNHP/opennhp/commit/558ccdfccfe8b251914a68d31906f713710e91bc))
* **demoapp:** reap expired pending users + only 409 on status=active ([9edb7cf](https://github.com/OpenNHP/opennhp/commit/9edb7cfbcf85fd4632e2756c1cb15dd84f030e52))
* **demoapp:** relay probe ctx, deterministic email lookup, password 72-byte cap, register/retry ([ba25a87](https://github.com/OpenNHP/opennhp/commit/ba25a87bd9b1174c68635885bd5d2f3a98b09a9e))
* **demoapp:** remove dead /api/register/retry that returned private key on token alone ([2aa36f5](https://github.com/OpenNHP/opennhp/commit/2aa36f5cefaddcfbd546730d9f1efbeef78b6659))
* **demoapp:** security review fixes — jose vuln, IdP username lockout, case-insensitive uniqueness, loopback bind, SPA type-check ([f43ffeb](https://github.com/OpenNHP/opennhp/commit/f43ffeb75fc215d3cd9eb05fb1a8ff940207b8a6))
* **demoapp:** serve SPA files from disk in non-webdist builds ([e265435](https://github.com/OpenNHP/opennhp/commit/e265435c9e803e527caf6a52afd4570e482a79a0))
* **demoapp:** serveSPA 404 on directories; run ratelimit GC on every Allow ([55ea6f6](https://github.com/OpenNHP/opennhp/commit/55ea6f6208a84037fed1a268c58bdc95328412e7))
* **demoapp:** session cookie Secure flag, OIDC panic, rebind guard, state invalidation, GH_OAUTH TOML hygiene ([bc425e2](https://github.com/OpenNHP/opennhp/commit/bc425e21ccc3d5aef9fd8e60ec0a6b18c88e0098))
* **demoapp:** stop service before binary upload to avoid ETXTBSY ([c5ce9b8](https://github.com/OpenNHP/opennhp/commit/c5ce9b8e08e46cf0d205aac2880319ada199d1e0))
* **demoapp:** tighten secret handling, non-root container, rate limiter GC, OAuth merge ([ace43df](https://github.com/OpenNHP/opennhp/commit/ace43df63ab680eb3202c78af5484e2ff6e59a01))
* **demoapp:** use /usr/sbin/nologin shell for demoapp system user ([f239d10](https://github.com/OpenNHP/opennhp/commit/f239d10bc89b23b8cb93562094fbbd3aa96224e0))
...
* **docker:** root entrypoint chowns bind mounts then drops to demoapp ([d5f990a](https://github.com/OpenNHP/opennhp/commit/d5f990af215fe198615fbd8ff56c15e938aef795))
