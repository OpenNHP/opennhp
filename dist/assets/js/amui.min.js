...
this.sticked=t>this.original.offsetTop?"sticky":!1,this.sticked?o.addClass(e.cls+a).css({top:n}):o.removeClass(e.cls+a).css({top:""})}},o.sticky=a,i.fn.sticky=n,i(window).on("load",function(){i("[data-am-sticky]").each(function(){var t=i(this),e=o.utils.options(t.attr("data-am-sticky"));n.call(t,e)})}),e.exports=a}),define("ui.tab",["core","zepto.extend.fx","zepto.extend.data","zepto.extend.selector"],function(require){"use strict";function t(t){return this.each(function(){var n=e(this),i=n.is(".am-tabs")&&n||n.closest(".am-tabs"),o=i.data("amui.tabs");o||i.data("amui.tabs",o=new a(i[0])),"string"==typeof t&&n.is(".am-tabs-nav a")&&o[t](n)})}require("core");var e=window.Zepto,n=e.AMUI,i=n.support.transition,o=n.support.animation,a=function(t){this.$element=e(t),this.$tabNav=this.$element.find(a.DEFAULTS.selector.nav),this.$navs=this.$tabNav.find("a"),this.$content=this.$element.find(a.DEFAULTS.selector.content),this.$tabPanels=this.$content.find(a.DEFAULTS.selector.panel),this.transitioning=null,this.init()};a.DEFAULTS={selector:{nav:".am-tabs-nav",content:".am-tabs-bd",panel:".am-tab-panel"},status:{active:"am-active"}},a.prototype.init=function(){this.$navs.on("click.tabs.amui",e.proxy(function(t){t.preventDefault(),this.open(e(t.target))},this)),this.$content.on("swipeLeft.tabs.amui",e.proxy(function(t){var n=this.getNextNav(e(t.target));n&&this.open(n)},this)),this.$content.on("swipeRight.tabs.amui",e.proxy(function(t){var n=this.getPrevNav(e(t.target));n&&this.open(n)},this))},a.prototype.open=function(t){if(t&&!this.transitioning&&!t.parent("li").hasClass("am-active")){var n=this.$tabNav,i=this.$navs,o=this.$content,a=t.attr("href"),s=/#.*$/,r=s.test(a)&&a||this.$tabPanels.eq(i.index(t)),l=n.find(".am-active a")[0],c=e.Event("open:tabs:amui",{relatedTarget:l});if(t.trigger(c),!c.isDefaultPrevented()){var u=e(r);this.activate(t.closest("li"),n),this.activate(u,o,function(){t.trigger({type:"opened:tabs:amui",relatedTarget:l})})}}},a.prototype.activate=function(t,n,o){function a(){o(),this.transitioning=!1}this.transitioning=!0;var s=n.find("> .am-active"),r=o&&i&&!!s.length;s.removeClass("am-active am-in").blur(),t.addClass("am-active"),r?(t.redraw(),t.addClass("am-in")):t.removeClass("am-fade"),r?s.one(i.end,e.proxy(a,this)):e.proxy(a,this)},a.prototype.getNextNav=function(t){var e=this.$tabPanels.index(t),n="am-animation-right-spring";return e+1>=this.$navs.length?(o&&t.addClass(n).on(o.end,function(){t.removeClass(n)}),null):this.$navs.eq(e+1)},a.prototype.getPrevNav=function(t){var e=this.$tabPanels.index(t),n="am-animation-left-spring";return 0===e?(o&&t.addClass(n).on(o.end,function(){t.removeClass(n)}),null):this.$navs.eq(e-1)},e.fn.tabs=t,e(document).on("ready",function(){e("[data-am-tabs]").tabs()})}),define("util.cookie",["core","zepto.extend.fx","zepto.extend.data","zepto.extend.selector"],function(require,t,e){"use strict";require("core");var n=window.Zepto,i=n.AMUI,o={get:function(t){var e,n=encodeURIComponent(t)+"=",i=document.cookie.indexOf(n),o=null;return i>-1&&(e=document.cookie.indexOf(";",i),-1==e&&(e=document.cookie.length),o=decodeURIComponent(document.cookie.substring(i+n.length,e))),o},set:function(t,e,n,i,o,a){var s=encodeURIComponent(t)+"="+encodeURIComponent(e);n instanceof Date&&(s+="; expires="+n.toGMTString()),i&&(s+="; path="+i),o&&(s+="; domain="+o),a&&(s+="; secure"),document.cookie=s},unset:function(t,e,n,i){this.set(t,"",new Date(0),e,n,i)}};i.utils.cookie=o,e.exports=o}),define("util.fastclick",[],function(require,t,e){/**
